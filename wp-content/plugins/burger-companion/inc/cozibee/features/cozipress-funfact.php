...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class Cozipress_funfact_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_CoziPress_funfact_upgrade_section up-to-pro" href="https://burgerthemes.com/cozipress-pro/" target="_blank" style="display: none;"><?php _e('More Funfact Available in CoziPress Pro','cozipress'); ?></a>
